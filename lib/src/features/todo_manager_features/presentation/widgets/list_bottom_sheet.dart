      ...
      child: ListView(
        children: <Widget>[
          ...
          StreamBuilder<QuerySnapshot>(
              stream: sl<FetchListTodos>()
                  .call(uid: sl<User>().uid, listId: widget.todoList.listId),
                ...
                if (snapshot.hasData) {
                  return Container(
                    ...
                    child: Column(
                        ...
                        children: snapshot.data.documents.map<Widget>((todo) {
                      return Container(
                        ...
                        child: ListTodoWidget(
                            ...
                            todo: ListTodoModel.fromFirestoreInfo(
                                listId: widget.todoList.listId, todoDoc: todo),
                            showDetails: true),
                      );
                    }).toList()),
                  );
